...
const Ai2022 = () => {
  ...
  const semesters = [
    { number: 1, title: "1st Semester", description: "Foundations of AI and programming basics" },
    { number: 2, title: "2nd Semester", description: "Core algorithms and data structures" },
    { number: 3, title: "3rd Semester", description: "Machine learning fundamentals" },
    { number: 4, title: "4th Semester", description: "Advanced AI techniques and applications" },
    { number: 5, title: "5th Semester", description: "Deep learning and neural networks" },
    { number: 6, title: "6th Semester", description: "AI systems design and ethics" },
    { number: 7, title: "7th Semester", description: "Specialized AI projects and research" },
    { number: 8, title: "8th Semester", description: "Capstone project and industry internship" },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {semesters.map((sem) => (
            <button
              key={sem.number}
              onClick={() => navigate(`/ai-dept/2022-scheme/semester-${sem.number}`)}
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-lg text-gray-500 group-hover:text-blue-100 transition-colors duration-300">
                    {sem.number === 1 ? 'st' : sem.number === 2 ? 'nd' : sem.number === 3 ? 'rd' : 'th'}
                  </span>
                </div>
