  ...
  const departments = [
    {
      ...
      description: "Dive into cutting-edge computing, software development, and system design.",
      link: "/cse-dept",
    ...
    },
    {
      ...
      description: "Unleash the power of AI, machine learning, and intelligent systems.",
      link: "/ai-dept",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {departments.map((dept, index) => (
            ...
            >
              <div className={`text-5xl mb-4 bg-gradient-to-r ${dept.color} bg-clip-text text-transparent animate-pulse`}>
                {dept.icon}
              </div>
