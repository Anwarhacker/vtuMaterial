...
const Home = () => {
  ...
  const features = [
    { title: "Study Materials", icon: "📚", description: "Access comprehensive notes, e-books, and curated PDFs for all VTU branches.", color: "bg-blue-100" },
    { title: "Question Papers", icon: "📝", description: "Practice with previous year papers and model tests, complete with solutions.", color: "bg-indigo-100" },
    { title: "Results Portal", icon: "🎯", description: "Check university and internal results instantly with personalized guidance.", color: "bg-purple-100" },
    { title: "Project Guidelines", icon: "💡", description: "Kickstart real-world projects with detailed documentation and templates.", color: "bg-green-100" },
    { title: "Lab Manuals", icon: "🧪", description: "Download ready-to-use lab manuals and code snippets for practicals.", color: "bg-yellow-100" },
    { title: "Event Updates", icon: "📅", description: "Stay updated on tech fests, workshops, hackathons, and placement drives.", color: "bg-red-100" }
  ];
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <div className="relative py-24 px-4 bg-gradient-to-br from-blue-600 to-indigo-800 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg sm:text-xl max-w-3xl mx-auto mb-8 opacity-90">
            Your one-stop platform for VTU students to access study resources, track results, and excel in projects with ease.
          </p>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            ...
            <div className="p-6">
              ...
              <p link href="#" className="text-gray-700 mt-2">Resources Available</p>
            </div>
            <div className="p-6">
      ...
      <div className="py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Simplify Your VTU Journey?</h2>
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            Join thousands of VTU students who trust us to provide high-quality resources, timely updates, and seamless academic support.
          </p>
          <button 
